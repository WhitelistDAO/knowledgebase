在学习中经常看到很多英文缩写却不知道是什么意思，于是我在网上收集整理了如下Web3行业黑话
...
Buying on secondary： 在二级市场购买，未在NFT首发买到，只能去交易平台购买

BUIDL - build useful stuff -：一般在下跌的时候，用有意义的分析证明价
...
floor price：地板价，意思就是这个NFT的最低价格
...
Faucet：水龙头，是指提供少量、免费的新型加密货币的网站或应用程序，以帮助提高人们持有加密货币的意识。
...
GOAT - Greatest Of All Time：有史以来最棒的，一般用作彩虹屁
...
Mint：铸造 NFT/ERC20，指在区块链上发行NFT的行为，发行方和用户都可以使用

Moon: to the moon, 暴涨。

Mainnet：主网，是指绝大多数人在使用的区块网络，用户在其上交易、构建智能合约，矿工上边挖矿。
...
To The Moon：到月球上去！出自去年散户大战华尔街事件，意思就是价格直插月球

Token Airdrops：又称为糖果空投，是指一将新的或是既有的项目将其代币按照某一规则进行免费派发，从而够吸引更多的用户加入并使用。
